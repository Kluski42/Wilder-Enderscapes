...
//        WWModelHelper.createStrippedHollowedLog(generator, STRIPPED_HOLLOWED_VEILED_LOG, STRIPPED_HOLLOWED_VEILED_LOG, STRIPPED_VEILED_LOG);
        ...
        WWModelHelper.createHollowedLog(generator, HOLLOWED_CELESTIAL_STEM, CELESTIAL_STEM, STRIPPED_CELESTIAL_STEM, CELESTIAL_STEM);
        WWModelHelper.createHollowedLog(generator, HOLLOWED_MURUBLIGHT_STEM, MURUBLIGHT_STEM, STRIPPED_MURUBLIGHT_STEM, MURUBLIGHT_STEM);
        WWModelHelper.createHollowedLog(generator, HOLLOWED_VEILED_LOG, VEILED_LOG, STRIPPED_VEILED_LOG, VEILED_LOG);

        WWModelHelper.createStrippedHollowedLog(generator, STRIPPED_HOLLOWED_CELESTIAL_STEM, STRIPPED_CELESTIAL_STEM, STRIPPED_CELESTIAL_STEM);
        WWModelHelper.createStrippedHollowedLog(generator, STRIPPED_HOLLOWED_MURUBLIGHT_STEM, STRIPPED_MURUBLIGHT_STEM, STRIPPED_MURUBLIGHT_STEM);
        WWModelHelper.createStrippedHollowedLog(generator, STRIPPED_HOLLOWED_VEILED_LOG, STRIPPED_VEILED_LOG, STRIPPED_VEILED_LOG);
    }
